...
#>
    ...
    $folder.items | Select-Object -Property Subject, Body, ReceivedTime, SenderName}

#Get-OutlookInBox
#Get-OutlookInBox | where { $_.ReceivedTime -gt [datetime]"5/5/17"} | sort ReceivedTime
Get-OutlookInBox | where { $_.SenderName -eq "Name"} | sort subject